...
class RoboFile extends Tasks implements LoggerAwareInterface, ConfigAwareInterface
{
    ...
    protected function getTaskPhpstanAnalyze(): TaskInterface
    {
        ...
        $checkstyleReporter->setDestination('reports/machine/checkstyle/phpstan.xml');

        return $this
            ->taskPhpstanAnalyze()
            ->setErrorFormat('json')
            ->addLintReporter('stdOutput-verbose', 'lintVerboseReporter')
            ->addLintReporter('reports-checkstyle', $checkstyleReporter);
    }
